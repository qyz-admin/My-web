...
// @require      file://H:\layer.js

// ==/UserScript==https://13.229.176.203/static/admin/js/tabs.js  // @grant        none
(function() {
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  var date=new Date();
      console.log(date);
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  function fn_nav() {//导航加载
    ...
    var wxzSearchBarNode = document.createElement('div');
        ...
        wxzSearchBarNode.style = "position: absolute;top: 14px; left: 205px;";//left:235
        wxzSearchBarNode.innerHTML =
      '&nbsp &nbsp <input placeholder=" 輸入--（編號）" class="search-button" id="wxz_input" type="hidden"> &nbsp &nbsp &nbsp\
                   <input type="button" value="&nbsp GO-客服 &nbsp" class="btn default showcol" id="wxcx_searchButton" >&nbsp\
                   <input type="button" value="&nbsp 促单查询 &nbsp" class="btn default showcol" id="w_searchButton" >&nbsp\
                   <input type="button" value="&nbsp 订单详情 &nbsp" class="btn default showcol" id="cd_searchButton" >&nbsp\
                   <input type="button" value="&nbsp 查詢-補發 &nbsp" class="btn default showcol" id="wxz_searchButton" >&nbsp\
                   <input type="button" value="&nbsp 信息表显示 &nbsp" class="btn green" id="xxb_searchButton"> &nbsp\
                   <input type="button" value="&nbsp win-open窗口 &nbsp" class="btn green" id="test_searchButton"> &nbsp\
<input type="button" value="&nbsp 信息55 &nbsp" class="btn green" id="xxbb_searchButton"> &nbsp\
                          &nbsp  &nbsp  &nbsp &nbsp &nbsp &nbsp\
<input type="button" value="&nbsp 导 出 &nbsp" class="tool-action btn yellow" id="save_searchButton"> &nbsp\
                   <input type="button" value="&nbsp 退 货 &nbsp" class="btn yellow-gold" id="th_searchButton"> &nbsp\
                   <input type="button" value="&nbsp 换 货 &nbsp" class="btn yellow-gold" id="hh_searchButton"> &nbsp\
                   <input type="button" value="&nbsp 补 发 &nbsp" class="btn yellow-gold" id="bf_searchButton"> &nbsp\
                   <input type="button" value="&nbsp 点击复制 &nbsp" class="btn green" id="fz_searchButton"> &nbsp\
<input type="button" value="&nbsp 点击复制  退 换 补&nbsp" class="tool-action btn yellow" id="ffz_searchButton">&nbsp &nbsp\;'
      targNode.appendChild(wxzSearchBarNode);
    //targNode.insertBefore(wxzSearchBarNode,oldNode);
  };
//-------------------------------------------------------------------------------------------------------------
...
//var thNode1 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByClassName("table table-striped table-bordered table-hover")[0];
    ...
    var djrvalue = document.createElement('select');
        ...
        djrvalue.style = "position: relative;"
                       + "float: left;"
                       + "top: 14px;"
                       + "left: 930px;"
                       + "height:30px;"
                    ...
                    <span class="arrow"></span>\
                      ...
                      <ul class="sub-menu">\
                           <li class="nav-item  " target="_blank">\
                                ...
                                <i class="iconfont"></i>\
                                <span class="title">登記退換貨表</span>\
                                </a>\
                           </li>\
<li class="nav-item">\
            <a id="add_tab" >\
            <i class="iconfont"></i>\
            <span class="title">信息表000000</span>\
            </a>\
</li>\
             <li id="demo_tab1" class="nav-item  " target="_blank">\
                   ...
                   <span class="title">信息表</span>\
                           ...
                           <li class="nav-item  ">\
                                <a href="https://fanyi.baidu.com/?aldtype=16047#auto/zh" class="nav-link "  id="tul_search">\
                                <i class="iconfont"></i>\
                                <span class="title">百度翻译</span>\
                                </a>\
                           </li>\
                           <li class="nav-item  ">\
                                <a href="//tvlove.club/giikin/set/email.html" class="nav-link ">\
                                <i class="iconfont"></i>\
                                <span class="title">邮箱登录</span>\
                                </a>\
                           </li>\
                           <li class="nav-item  ">\
                                <a href="https://www.hct.com.tw/search/searchgoods_n.aspx" class="nav-link ">\
                                <i class="iconfont"></i>\
...
*/
 ...
 /*
   var stNode110 = document.createElement('script');
        stNode110 .innerHTML =
                  'layui.use(["layer", "form"], function(){'
                       +'var layer = layui.layer'
                         +' ,form = layui.form;'
                   +'});'
        xxbdemo.appendChild(stNode110);
*/
                          ...
                          +'<div class="layui-card-body">'
                           +'<div class="layui-form">'
                            +'<table class="layui-table"><colgroup><col width="150"><col width="150"><col width="200"><col></colgroup>'
                                +'<thead><tr><th>前称</th><th>后缀</th><th>密码</th></tr></thead>'
                                +'<tbody><tr>'
                                    ...
                                    +'<td onclick="ad2(2)"><div class="js-copy" data-clipboard-text="libaka@gk.2018!"><span>libaka@gk.2018!</span></div></td></tr>'
                                +'<tr>'
                                    ...
                                    +'<td onclick="ad2(5)"><div class="js-copy" data-clipboard-text="Service123"><span>Service123</span></div></td></tr>'
                                +'<tr>'
                                    ...
                                    +'<td onclick="ad2(8)"><div class="js-copy" data-clipboard-text="Service@123"><span>Service@123</span></div></td></tr>'
                                +'<tr>'
                                    ...
                                    +'<td onclick="ad2(11)"><div class="js-copy" data-clipboard-text="Service123"><span>Service123</span></div></td></tr>'
                                +'<tr>'
                                    ...
                                    +'<td onclick="ad2(14)"><div class="js-copy" data-clipboard-text="Service123"><span>Service123</span></div></td></tr>'
                                 +'<tr>'
                                    +'<td onclick="ad2(15)"><div class="js-copy" data-clipboard-text="service"><span>service</span></div>'
                                    +'<td onclick="ad2(16)"><div class="js-copy" data-clipboard-text="geegonlie.com"><span>geegonlie.com</span></div></td>'
                                    +'<td onclick="ad2(17)"><div class="js-copy" data-clipboard-text="geego@tw88!"><span>geego@tw88!</span></div></td></tr>'
                                  +'<tr>'
                                    +'<td onclick="ad2(18)"><div class="js-copy" data-clipboard-text="service"><span>service</span></div>'
                                    +'<td onclick="ad2(19)"><div class="js-copy" data-clipboard-text="cocalot.com"><span>cocalot.com</span></div></td>'
                                    +'<td onclick="ad2(20)"><div class="js-copy" data-clipboard-text="Line.tw@2019/"><span>Line.tw@2019/</span></div></td></tr>'
                                   +'<tr>'
                                    +'<td onclick="ad2(21)"><div class="js-copy" data-clipboard-text="service"><span>service</span></div>'
                                    +'<td onclick="ad2(22)"><div class="js-copy" data-clipboard-text="lycocode.com"><span>lycocode.com</span></div></td>'
                                    +'<td onclick="ad2(23)"><div class="js-copy" data-clipboard-text="Taiwan1011#9120"><span>Taiwan1011#9120</span></div></td></tr>'
                                +'</tbody>'
                            +'</table>'
              //   +'<br>'
                   +'<a href="http://tvlove.club/giikin/set/email.html" target="_blank">快捷郵箱地址：&nbsp;&nbsp;&nbsp;http://tvlove.club/giikin/set/email.html</a>'
                 +'<br>'
                 +'<br>'
                 +'</div>'
           +'</div>'
     ...
     +'</div>'//111111
            +'<div class="col-md-6">'//22222
                +'<div class="layui-card">'
                    +'<div class="layui-card-header" style="font-size: 28px;">Line</div>'
                    +'<div class="layui-card-body">'
                        +'<div class="layui-form">'
...
/*     var stNode19 = document.createElement('script');
 ...
 /*
      var xxbNode00 = document.createElement('script');
          xxbNode00.innerHTML =
          ...
          +'clipboard.on("error", function(e) {'
            +'layer.msg("复制失败");'
          +'});'
         xxbdemo.appendChild(xxbNode00);*/

   /*   var xxbNode000 = document.createElement('script');
          xxbNode000.innerHTML =
          'var tdList = document.getElementById("tab_iframe_信息表").contentDocument.getElementsByClassName("js-copy");'
           +'for(var i in tdList){tdList[i].onclick = testClick;};'
        +'function testClick() {'
          +'var text= document.getElementById("tab_iframe_信息表").contentDocument.getElementsByClassName("js-copy")[i].firstElementChild.innerText;'
                   +'console.log(text);'
          +'var textArea = document.createElement("input");'
              +'textArea.value = text;'
          +'document.body.appendChild(textArea);'
          ...
          +'setTimeout(function () {'
             ...
             +'}, 100);'
         +'};'
         xxbdemo.appendChild(xxbNode000);*/
//    };
...
function xxbTab() {
    ...
    /*document.getElementById("demo_tab").addEventListener("click", function fn() {
     /*  setTimeout(function () {
        var xxbdemo= document.getElementById("tab_iframe_信息表").contentDocument.getElementsByTagName("body")[0];
            console.log(xxbdemo);
        var xxbNode = document.createElement('div');
 ...
 /*    setTimeout(function () {
         document.getElementById("tab_iframe_信息表").addEventListener("load", function fn() {
        var xxbdemo= docsetTimeout(function () {ument.getElementById("tab_iframe_信息表").contentDocument.getElementsByTagName("body")[0];
            console.log(xxbdemo);
        var xxbNode = document.createElement('div');
            xxbNode.setAttribute('class','tab_conten');
            xxbNode.setAttribute('id','tab_conten_信息表');
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 document.getElementById("w_searchButton").addEventListener("click", function fn() {//快捷-测试查詢
